...
The following packages are part of output of my research on GAM models:

   - **mgcViz**: visual tools for Generalized Additive Models. See the github [source code](https://github.com/mfasiolo/mgcViz) and the [online manual](https://mfasiolo.github.io/mgcViz/). Available on [CRAN](https://cran.r-project.org/web/packages/mgcViz/index.html).
